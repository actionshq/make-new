...
const actionGenerator = computed(() => props.actions ? loopGenerator(props.actions) : undefined)

const transitionInterval = useInterval(4000)
const currentAction = computed(() => actionGenerator.value?.next(transitionInterval.value).value)
</script>
