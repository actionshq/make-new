<template>
  <DefaultLayout>
    ...
    <p>
      Marek Brieger <br />
      Albrecht-Achilles-Straße 56<br />
      10709 Berlin <br />
    </p>
    <h2 class="my-4 font-bold text-lg">Vertreten durch</h2>
    <p>Marek Brieger</p>
    <h2 class="my-4 font-bold text-lg">Kontakt</h2>
    <p>
      Telefon: 08003301000<br />
      E-Mail: <a href="mailto:contact@appcited.com">contact@appcited.com</a>
    </p>
    <h2 class="my-4 font-bold text-lg">
    ...
    <h2 class="my-4 font-bold text-lg">Haftungsausschluss</h2>
    <h3 class="my-4 font-bold">Haftung für Inhalte</h3>
    <p>
    ...
    <h3 class="my-4 font-bold">Haftung für Links</h3>
    <p>
    ...
    <h3 class="my-4 font-bold">Urheberrecht</h3>
    <p>
